...
from common.waveform_augment import WaveformAugmenter, WaveformAugmentConfig
...
def main():
    ...
    # 音频预处理器
    waveform_augmenter = WaveformAugmenter(WaveformAugmentConfig(sample_rate=22050))
